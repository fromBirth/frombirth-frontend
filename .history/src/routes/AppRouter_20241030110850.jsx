...
import { Routes, Route, Navigate } from 'react-router-dom'; // React Router의 Routes와 Route 컴포넌트를 사용해 라우팅 구성
import { Suspense, lazy } from 'react'; // React에서 컴포넌트를 동적 로딩할 수 있도록 Suspense와 lazy를 사용
import { PATHS } from './paths'; // PATHS 객체를 import하여 경로를 상수로 관리
import Layout from '../components/Layout.jsx'; // 전체 레이아웃 컴포넌트로, 로그인이 필요한 페이지의 공통 레이아웃으로 사용
