...
import {getDiaryPhotos} from "../DiaryCommonFunction.js";
...
const DiaryListPhoto = () => {
    ...
    return (
        <div>
            {photoInfoList && photoInfoList.pages.length > 0 && photoInfoList.pages.some(page => page.data.length > 0) ? (
                photoInfoList.pages.map((page, index) => (
                    <Fragment key={index}>
